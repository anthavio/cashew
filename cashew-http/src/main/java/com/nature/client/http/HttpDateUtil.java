...
public final class HttpDateUtil {
	...
	*/
	...
	private static final Collection<String> DEFAULT_PATTERNS = Arrays.asList(new String[] { PATTERN_ASCTIME,
	 ...
	 */
	public static Date parseDate(String dateValue, Collection<String> dateFormats) throws ParseException {
