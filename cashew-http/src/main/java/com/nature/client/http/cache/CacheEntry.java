...
public class CacheEntry<T extends Serializable> implements Serializable {
	...
	public Date getSoftExpire() {
		return new Date(sinceDate.getTime() + (softTtl * 1000));
	}
	...
	public Date getHardExpire() {
		return new Date(sinceDate.getTime() + (hardTtl * 1000));
	}

	@Override
	public String toString() {
		return "CacheEntry [since=" + sdf.format(sinceDate) + ", hard=" + sdf.format(getHardExpire()) + ", soft="
				+ sdf.format(getSoftExpire()) + ", "
